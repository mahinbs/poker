...
export default function CashierSignIn() {
  ...
  const handleSubmit = (e) => {
    ...
    if (credentials.email === "cashier@pokerroom.com" && credentials.password === "cashier123") {
      navigate("/cashier");
    } else {
      setError("Invalid credentials. Use cashier@pokerroom.com / cashier123");
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black flex items-center justify-center">
      <div className="max-w-md w-full mx-4">
        ...
        <div className="text-center mb-8">
          <div className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-300 to-teal-400 drop-shadow-lg mb-4">
            Cashier Portal
          </div>
          <p className="text-gray-300">Financial Processing & Payroll Management</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-800 via-gray-900 to-black rounded-2xl p-8 shadow-2xl border border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-bold py-3 px-4 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              Sign In to Cashier Portal
            </button>
          </form>
          ...
          <div className="mt-6 p-4 bg-green-500/20 border border-green-500/30 rounded-lg">
            <p className="text-green-300 text-sm text-center">
              ...
              Email: cashier@pokerroom.com<br />
              Password: cashier123
            </p>
          </div>
