...
export default function CashierSidebar({ 
  ...
  return (
    <>
      {isMobile && (
        <button
          className="sidebar-toggle fixed top-4 left-4 z-50 bg-gradient-to-r from-green-500 to-emerald-600 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 lg:hidden"
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center text-white min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-lg font-semibold truncate">Cashier</div>
                <div className="text-sm opacity-80 truncate">
                  cashier@pokerroom.com
                </div>
              </div>
            </div>
          </div>
